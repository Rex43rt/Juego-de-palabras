...
document.getElementById("player_question").innerHTML="Turno para perguntar : "+player1_name;
document.getElementById("player_answer").innerHTML="Turno para responder : "+player2_name;
function send(){
    get_word=document.getElementById("word").value;
    word=get_word.toLowerCase();
    console.log("plalabra en minusculas= "+word);
...
function check(){
    ...
    if(question_turn=="player1"){
        ...
        if(answer_turn=="player1"){
            ...
            answer_turn="player1"
            document.getElementById("player_answer").innerHTML="turno para responder - "+playe1_name;
        }
